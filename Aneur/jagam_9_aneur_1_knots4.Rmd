...
dir <- "/Users/lizbethna/Documents/Sabatico/Examples/Aneur/"
...
```{R, eval=TRUE, fig.show="hold", echo=TRUE, include=TRUE, out.width="100%", warning=FALSE, message=FALSE}
pairs(fit.lme.incr.reslope, pars = c("b0","b1"), las = 1)
```
...
stan_plot(fit.lme.add.non.reslope, pars=c("invtau2","tau2","tau", "invsig2","sig2","sigma",  "lambda","rho"), point_est = "mean", show_density = TRUE)
