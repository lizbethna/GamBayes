...
dir <- "~/Documents/Sabatico/Examples/Simula_f1increasing 231028/Resultados N20 re1 casoD/"
...
f1error <- function(x) 10 + 0.1*(((x-5))^3) + rnorm(length(x),0,1.5)   ### Si es monotona, mas un error  
